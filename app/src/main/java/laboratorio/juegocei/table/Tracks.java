    ...
    public Track table3() {
        ...
        SubTrack subTrack5 = new SubTrack(
            Arrays.asList(
                ...
                new Destination(new Reference(new Point(convertX(445), convertY(1174))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(423), convertY(1172))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(401), convertY(1169))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(379), convertY(1165))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(358), convertY(1160))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(333), convertY(1154))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(297), convertY(1141))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(265), convertY(1128))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(237), convertY(1114))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(213), convertY(1100))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(192), convertY(1088))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(173), convertY(1074))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(156), convertY(1060))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(138), convertY(1045))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(122), convertY(1031))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(108), convertY(1015))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(96), convertY(999))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(84), convertY(982))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(74), convertY(962))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(66), convertY(932))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(63), convertY(903))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(63), convertY(889))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(64), convertY(869))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(65), convertY(854))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(69), convertY(833))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(73), convertY(819))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(81), convertY(800))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(100), convertY(765))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(124), convertY(734))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(147), convertY(711))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(178), convertY(688))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(207), convertY(670))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(242), convertY(653))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(275), convertY(639))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(302), convertY(630))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(333), convertY(623))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(367), convertY(616))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(397), convertY(612))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(427), convertY(609))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(455), convertY(607))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(473), convertY(607))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(491), convertY(607))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(515), convertY(607))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(541), convertY(608))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(569), convertY(610))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(596), convertY(614))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(625), convertY(619))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(659), convertY(626))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(691), convertY(637))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(716), convertY(646))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(738), convertY(655))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(760), convertY(667))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(783), convertY(682))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(805), convertY(699))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(826), convertY(720))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(842), convertY(739))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(851), convertY(752))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(865), convertY(774))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(876), convertY(798))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(884), convertY(822))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(889), convertY(843))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(893), convertY(862))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(895), convertY(883))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(896), convertY(903))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(895), convertY(913))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(894), convertY(925))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(886), convertY(949))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(875), convertY(970))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(861), convertY(989))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(845), convertY(1008))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(830), convertY(1026))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(813), convertY(1041))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(797), convertY(1055))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(781), convertY(1066))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(765), convertY(1077))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(748), convertY(1088))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(734), convertY(1096))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(714), convertY(1107))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(697), convertY(1117))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(680), convertY(1125))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(661), convertY(1133))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(644), convertY(1140))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(629), convertY(1146))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(615), convertY(1150))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(599), convertY(1156))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(583), convertY(1159))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(567), convertY(1163))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(551), convertY(1166))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(535), convertY(1169))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(521), convertY(1172))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(508), convertY(1173))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(494), convertY(1174))), Arc.LINE),
                new Destination(new Reference(new Point(convertX(481), convertY(1174))), Arc.LINE),
                new Destination(this.letterA, Arc.LINE),
                new Destination(this.cornerLDown, Arc.LINE),
                new Destination(this.letterK, Arc.LINE)
            ),
